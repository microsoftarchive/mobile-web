...
namespace MileageStats.Domain.Contracts.Data
{
    public interface IReminderRepository
    {
        ...
        IEnumerable<Reminder> GetOverdueReminders(int vehicleId, DateTime forDate, int forOdometer);

        IEnumerable<Reminder> GetUpcomingReminders(int vehicleId, DateTime forStartDate, DateTime forEndDate,
